...
public class WebServiceConfig extends WsConfigurerAdapter {
    ...
    @Bean(name = "credit")
    public DefaultWsdl11Definition creditWsdl11Definition(XsdSchema creditSchema) {
        DefaultWsdl11Definition wsdl11Definition = new DefaultWsdl11Definition();
        wsdl11Definition.setResponseSuffix("Response");
        wsdl11Definition.setRequestSuffix("Request");
    ...
    @Bean(name = "debit")
    public DefaultWsdl11Definition debitWsdl11Definition(XsdSchema debitSchema) {
        DefaultWsdl11Definition wsdl11Definition = new DefaultWsdl11Definition();
        wsdl11Definition.setResponseSuffix("Response");
        wsdl11Definition.setRequestSuffix("Request");
        wsdl11Definition.setPortTypeName("debitPort");
        wsdl11Definition.setLocationUri("/ws");
        wsdl11Definition.setTargetNamespace("http://alcatel-lucent.com/esm/ws/svcmgr/V2_0");
        wsdl11Definition.setSchema(debitSchema);
        return wsdl11Definition;
    }
    ...
    @Bean
    public XsdSchema debitSchema() {
        return new SimpleXsdSchema(new ClassPathResource("xsd/debit.xsd"));
    }
